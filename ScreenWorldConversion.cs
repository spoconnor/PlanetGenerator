...
namespace PlanetGenerator
{
    public class ScreenWorldConversion
    {
        ...
        public static Vector3d ScreenToWorld(Vector2d pos, Matrix4d modelviewMatrix, Matrix4d projectionMatrix, int[] viewport)
        {
            ...
            GL.ReadPixels((int)pos.X, viewport[3] - (int)pos.Y, 1, 1, OpenTK.Graphics.OpenGL.PixelFormat.DepthComponent, PixelType.Float, boxedZ);
            win.Z = boxedZ[0];
            win.Z = zz;

            Console.WriteLine("{0}, {1}", win.Z, zz);
